...
boxplot(MedDistDf, range=10,main="Median Euclidean distance from PCA")
...
boxplot(MedDistDfFA, range=1.5,main="Median Euclidean distance from FA")
...
lm<-lmer(Comp.1~Fxn +Sample+(1|scores$Biorep)+(1|scores$Rep),data=scores)
Anova(lm)
lm<-lmer(Comp.2~Fxn+ Sample+(1|scores$Rep),data=scores)
Anova(lm)
#Therefore, fractions have a significant effect on the clustering in the first two principle components.
```
